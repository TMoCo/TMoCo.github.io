...
This deferred renderer stems from a piece of coursework, a gltf loader and viewer, made for my master's high performance graphics module.
...
- physically based shading (based on the Unreal)
...
- more post processing effects (HDR lighting, bloom, lens flare and blur)
